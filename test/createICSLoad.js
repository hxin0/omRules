describe('Carrier360Mobile Test Data', function() {
    ...
    it.skip('to skip eom load creation, using ~~LS53262~~ instead', function() {
	...
	it('should be able to book an ICS load from eom', function() {
        //var loadCount = 3; //for multiple loads
		//browser.url('http://my.jbhunt.com/');
        //var mainTab = browser.getCurrentTabId();
		//browser.click('=Show More Apps');
        //browser.waitForExist('=Enterprise Order Management');
    ...
    it.skip('should find the load from FM2', function() {
        //browser.switchTab();
    ...
    it.skip('should preplan the load', function() {
        console.log('preplan!!!');
        browser.waitForEnabled('input[id="form:j_id1299:_3"]');
        browser.click('input[id="form:j_id1299:_3"]');
        browser.waitForExist('img[id="form:segments:0:j_id1440:0:j_id1445"]');
        browser.click('img[id="form:segments:0:j_id1440:0:j_id1445"]');
        // browser.waitForExist('img[id="form:segments:1:j_id1440:0:j_id1445"]');
        // browser.click('img[id="form:segments:1:j_id1440:0:j_id1445"]');
        browser.waitForEnabled('input[id="form:driverUi"]');
        browser.setValue('input[id="form:driverUi"]', 'AABD1');
        browser.setValue('input[id="form:j_id1351"]', 'SR');
        //browser.debug();
