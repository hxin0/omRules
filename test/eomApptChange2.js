    ...
    it('should change appt date and time for all the available loads in first page', function() {
        ...
        for (i = 0; i < loadsValue.length; i++) {
            if (eomAppt.newAppt.status2Change.includes(loadsValue[i].status)) {
                ...
                browser.pause(2000);
                browser.waitForEnabled('[id="frmOrderApptMaint:lOrderStopsDetails:0:cmdLnkStopNumberActionFocusLink"]', 25000);
                browser.click('[id="frmOrderApptMaint:lOrderStopsDetails:0:cmdLnkStopNumberActionFocusLink"]');
                ...
                //browser.pause(6000);
                browser.waitForEnabled('[id="frmOrderApptMaint:lOrderStopsDetails:1:cmdLnkStopNumberActionFocusLink"]', 25000);
                browser.click('[id="frmOrderApptMaint:lOrderStopsDetails:1:cmdLnkStopNumberActionFocusLink"]');
